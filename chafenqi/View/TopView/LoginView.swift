...
struct LoginView: View {
    ...
    func login(username: String, password: String) async -> String {
        do {
            ...
            return try await AuthServer.auth(username: username, plainPassword: password)
    ...
    func register(username: String, password: String) async -> Bool {
        do {
            ...
            guard (try await AuthServer.register(username: username, plainPassword: password)) else {
                // Username not unique
